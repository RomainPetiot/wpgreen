...
function cl_dashboard() {
    wp_add_dashboard_widget('cl_dashboard_widget', 'Contact','cl_custom_dashboard_message');
}
function cl_custom_dashboard_message(){
    $posts = get_posts(array(
        'posts_per_page'    => 10,
        'post_type'         => 'wpgreen_contact',
        'post_status'       => 'publish',
        ));
    ?>
	<ul>
	...
	<a href="?page=wpgreen_download_report&report=wpgreen_contact" class="button">Export CSV</a>
	<?php
}
